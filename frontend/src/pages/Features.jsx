...
const Features = () => {
    ...
    return (
        <div
            ref={containerRef}
            className="bg-[#F9F0D3] min-h-screen text-white px-8 md:px-16 lg:px-24 py-20"
        >
                ...
                <div className="max-w-2xl space-y-4">
                    ...
                    >
                        {headingText.map((word, index) => (
                            <span
                                key={index}
                                className={`inline-block ${word === "consulting" ? "text-green-600" : "text-gray-600"
                                    }`}
                            >
                                {word}
                            </span>
                ...
                {features.map((feature, index) => (
                    <div
                        ...
                        className={`p-6 rounded-2xl transition-transform transform hover:-translate-y-2 hover:scale-105 group cursor-pointer ${index % 2 === 0
                            ? "bg-gray-800 shadow-lg shadow-green-600/30 hover:shadow-green-600/50"
                            : "text-gray-600 hover:shadow-lg hover:shadow-gray-600/30 hover:text-shadow-gray-950"
                            }`}
                    >
                        {/* Icon Box */}
