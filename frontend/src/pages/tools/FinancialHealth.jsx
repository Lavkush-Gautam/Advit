...
const FinancialHealth = () => {
  ...
  const questions = [
    "What is your primary financial goal? (e.g., wealth growth, stable income, capital protection)",
    "How long can you keep your money invested before you need it?",
    "How do you usually react when your investments lose value?",
    ...
    "If you invest in stocks and they fall 20%, what would you do?",
    "What type of investments are you most comfortable with? (Fixed deposits, mutual funds, stocks, real estate, crypto)",
    "How much risk are you willing to take to achieve higher returns?",
  ];
