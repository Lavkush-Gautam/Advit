...
const Contacts = () => {
  ...
  return (
    <div ref={containerRef}>
      ...
      <div 
        ref={headerRef}
        className='w-full flex h-[200px] bg-gradient-to-r bg-[#F9F0D3] items-center justify-center'
      >
        <h1 className='text-gray-600 text-5xl md:text-6xl font-bold tracking-tight'>
          Contact Us
        </h1>
      </div>
